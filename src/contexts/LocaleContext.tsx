...
const translations: Record<Locale, Record<string, string>> = {
  ...
  'pt-BR': {
    ...
    'login.mfaSubtitle': 'Digite o código de 6 dígitos do seu aplicativo autenticador',
  ...
  'es-ES': {
    ...
    'login.mfaSubtitle': 'Ingresa el código de 6 dígitos de tu aplicación de autenticación',
    'login.verifying': 'Verificando...',
    'login.verify': 'Verificar',
    'login.cancel': 'Cancelar',
