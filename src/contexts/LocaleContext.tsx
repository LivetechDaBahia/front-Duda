...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "workflow.filters.searchPlaceholder": "Search by quote or sales order number",
  ...
  "pt-BR": {
    ...
    "workflow.filters.searchPlaceholder": "Buscar por cotação ou número do pedido",
    "workflow.filters.status": "Status",
  ...
  "es-ES": {
    ...
    "workflow.filters.filters": "Filtros",
    "workflow.filters.search": "Buscar",
    "workflow.filters.searchPlaceholder": "Buscar por cotización o número de orden",
