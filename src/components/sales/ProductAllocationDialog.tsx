                ...
                <TableBody>
                  {allocations.map((row, idx) => (
                    <TableRow key={`alloc-${idx}`}>
                      ...
                      <TableCell className="whitespace-nowrap">{row.proposal || "-"}</TableCell>
                      ...
                      <TableCell className="whitespace-nowrap text-right">{row.amountAvailable}</TableCell>
                      <TableCell className="whitespace-nowrap text-right">{row.amountReserved}</TableCell>
                      <TableCell className="whitespace-nowrap text-right">{row.amountOp}</TableCell>
                      <TableCell className="whitespace-nowrap text-right">{row.amountPo}</TableCell>
                      <TableCell className="whitespace-nowrap text-right">{row.amountSc}</TableCell>
                      <TableCell className="whitespace-nowrap">{row.productSequence || "-"}</TableCell>
